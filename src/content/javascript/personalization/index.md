...
You can create a widget under **Implementation > Widgets**. Each widget has a unique ID that identifies it on the page. If the same widget is inserted in multiple places, the code will only be included once and each instance will call into it by ID.
